...
class SugarCrepe_pp(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        item = edict({"image_options": [img], "caption_options": [caption, caption2, negative_caption]})
        return item
    ...
    def evaluate_scores(self, scores):
        ...
        preds = np.argmin(np.squeeze(scores_i2t, axis=1), axis=-1)
        correct_mask = (preds == 2)
